...
option_list <- list(
  ...
  make_option(
    c("--genes_to_include"), type = "character", help = "List of features to include in count matrix."
  )
)
...
# # ### Testing
# opts = list()
# opts$input_10x_dir = "results/multiome/nf_gex_results/starsolo/Sample_5124-NM-1-hg38/Sample_5124-NM-1-hg38.Solo.out/GeneFull_ExonOverIntron/raw"
# opts$barcodes_nuclei = "results/multiome/cross_modality_qc/Sample_5124-NM-1/barcodes_nuclei_gex.txt"
# opts$barcodes_empty = "results/multiome/cross_modality_qc/Sample_5124-NM-1/barcodes_empty_gex.txt"
# opts$counts_nuclei = "results/multiome/counts_by_sample_gex/Sample_5124-NM-1/counts_nuclei.rds"
# opts$counts_empty = "results/multiome/counts_by_sample_gex/Sample_5124-NM-1/counts_empty.rds"
# opts$genes_to_include = "resources/hg38/hg38.refGene.protein_coding_genes_CVB4.bed"
...
protein_coding_genes = unique(scan(opts$genes_to_include, what = "character"))
