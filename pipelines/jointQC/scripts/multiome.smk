...
rule all:
    input:
        ...
        #~~~~~~~~ prepare_rna_data
        expand(_results("counts_by_sample_gex/{sample}/counts_nuclei.rds"), sample="Sample_5124-NM-1"),
...
rule cross_modality_qc:
    ...
    output:
        _results("cross_modality_qc/{sample}/barcodes_nuclei_gex.txt"),
        _results("cross_modality_qc/{sample}/barcodes_nuclei_atac.txt"),
        _results("cross_modality_qc/{sample}/barcodes_empty_gex.txt"),
        _results("cross_modality_qc/{sample}/barcodes_empty_atac.txt"),
        _results("cross_modality_qc/{sample}/cross_modality_qc.tsv"),
        #_results("cross_modality_qc/{sample}/qc_density_all_facet_nuclei.png.png"),
...
rule prepare_rna_counts:
    input:
        ...
        genes_to_include = _resources("hg38/hg38.refGene.protein_coding_genes_CVB4.bed"),
    output:
    ...
    shell:
        ...
        Rscript workflow/scripts/prepare_rna_counts.R \
            ...
            --genes_to_include {input.genes_to_include}
        """
