...
# ## Testing
# opts=list()
# opts$gex_qc = "/scratch/scjp_root/scjp0/ccrober/preprocessing/10965-VD/work/multiome-rna/results/qc/10965-VD-2-hg38.qc.txt"
# opts$droplet_utils_nuclei = "results/droplet_utils/10965-VD-2/barcodes_nuclei.txt"
# opts$droplet_utils_empty = "results/droplet_utils/10965-VD-2/barcodes_empty.txt"
